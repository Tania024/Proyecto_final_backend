...
public class GestionDatos {
    ...
    public void init() {
        ...
        cliente.setCli_contrasena("Tania");
        cliente.setCli_estado("Activo");
        daoCliente.insert(cliente);

        Cliente cliente2 = new Cliente();
        cliente2.setCli_codigo(2);
        cliente2.setCli_cedula("1400730618");
        cliente2.setCli_direccion("Cuenca");
        cliente2.setCli_nombre("Irar");
        cliente2.setCli_telefono("0990323510");
        cliente2.setCli_apellido("Nankamai");
        cliente2.setCli_usuario("Irar");
        cliente2.setCli_contrasena("Irar");
        cliente2.setCli_estado("Inactivo");
