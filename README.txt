...
a persistence unit "proyecto_finalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "proyecto_final/pom.xml":
...
artifact ("proyecto_final.war") is already built. You can build
